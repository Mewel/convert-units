declare module "convert-units" { 
    ...
    type uMass = "mcg" | "mg" | "g" | "kg" | "oz" | "lb" | "t" | "st" | "lt"; // Mass
    type uVolume = "mm3" | "cm3" | "ml" | "l" | "kl" | "m3" | "km3" | "tsp" | "Tbs" | "in3" | "fl-oz" | "cup" | "pnt" | "qt" | "gal" | "ft3" | "tsp-us" | "Tbs-us" | "in3-us" | "fl-oz-us" | "cup-us" | "pnt-us" | "qt-us" | "gal-us" | "ft3-us" | "yd3-us" // Volume
    ...
    type uTemperature = "C" | "F" | "K" | "R" | "C-"; // Temperature
    ...
    type uPartsPer = "ppm" | "ppb" | "ppt" | "ppq" | "permille"; // Parts-Per
    ...
    type uEnergy = "Wh" | "mWh" | "kWh" | "MWh" | "GWh" | "J" | "kJ" | "kcal"; // Energy
    type uReactiveEnergy = "VARh" | "mVARh" | "kVARh" | "MVARh" | "GVARH"; // Reactive Energy
    type uAngle = "deg" | "rad" | "grad" | "arcmin" | "arcsec"; // Angle
    type uDensity = "kg/m3" | "g/cm3";
    type uPopulationDensity = "pop/km2" | "pop/mi2" ;
